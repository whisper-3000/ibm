...
def main():
    ...
    while True:
        input_method = input('\nIndique a continuación el método de entrada (0 = manual, 1 = archivo CSV input.csv): ')
    ...
    # Request variables
    num_neighbors = input('\nIndique la cantidad de vecinos a considerar: ')
    distance_type = input('\nIndique el tipo de distancia a utilizar (0 = Euclidiana, 1 = Manhattan): ')
